        ...
        <section id="about" className={'bg-richBlack'}>
            <Container>
                <div className={'grid lg:grid-cols-2 grid-cols-1 lg:grid-rows-2 grid-rows-1 lg:h-[541px] lg:gap-[30px] gap-[23px] lg:mb-[30px] mb-[23px]'}>
                    <div className={'bg-[url("../image/markio-mokup.jpg")] z-10 lg:bg-contain bg-cover relative overflow-hidden lg:h-auto h-[312px] lg:rounded-[23px] rounded-[10px] bg-no-repeat bg-top border border-gunMetal row-span-2 group flex items-end justify-between p-[40px]'}>
                        <div className={'bg-gradient-to-b w-full z-20 h-full absolute top-0 left-0 from-richBlack/20 via-richBlack/50 to-chineseBlack pointer-events-none'}/>
                        <div className={'group-hover:opacity-100 z-30 group-hover:translate-x-0 lg:opacity-0 lg:translate-x-[-20px] transition-all duration-500 w-[75%]'}>
                    ...
                    <div className={'overflow-hidden bg-gradient-to-b from-richBlack/20 lg:h-auto h-[195px] to-chineseBlack rounded-[23px] p-[40px] group relative border border-gunMetal'}>
                        ...
                        <div className={'group-hover:opacity-100 group-hover:translate-x-0 lg:opacity-0 lg:translate-x-[-20px] transition-all duration-500 w-[75%]'}>
                    ...
                    <div className={'overflow-hidden bg-gradient-to-b from-richBlack/20 lg:h-auto h-[195px] to-chineseBlack rounded-[23px] p-[40px] group relative border border-gunMetal flex items-center justify-start'}>
                        ...
                        <div className={'group-hover:opacity-100 group-hover:translate-x-0 lg:opacity-0 lg:translate-x-[-20px] transition-all duration-500'}>
                ...
                <div className="grid lg:grid-cols-2 lg:grid-rows-2 lg:h-[541px] lg:gap-[30px] gap-[23px]">
