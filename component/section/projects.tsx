    ...
    <section className={className} id="projects">
      <main className="p-4">
        <div className="prose prose-neutral dark:prose-invert w-full max-w-2xl mx-auto mb-5">
          <h2>Projects</h2>
          <p>
            A mix of client work and personal builds — booking platforms, admin
            dashboards, and internal tools shipped for real users, alongside
            side projects where I get to explore ideas end to end.
          </p>
        </div>
