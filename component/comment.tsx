...
export default function Comment({children, name}:commentType):ReactNode {
    // Returning JSX
    return (
        <div className={'bg-gradient-to-br from-richBlack to-chineseBlack border border-gunMetal lg:rounded-[23px] rounded-[10px] lg:py-[50px] py-[30px] lg:px-[50px] px-[20px] lg:h-[300px] h-[200px] flex flex-col items-start justify-between'}>
